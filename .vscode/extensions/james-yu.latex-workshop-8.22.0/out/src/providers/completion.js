...
exports.SnippetCompleter = exports.Completer = void 0;
...
const snippet_1 = require("./completer/snippet");
...
class SnippetCompleter {
    constructor(extension, triggerCharacter) {
        this.snippet = new snippet_1.Snippet(extension, triggerCharacter);
