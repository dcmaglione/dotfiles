...
- Using dynamic debugging configurations
  ...
  ![Run dynamic debugging configuration](https://github.com/microsoft/vscode-react-native/raw/HEAD/images/dynamic-debugging-configuration.gif)
...
- Using `Debug` button in the Editor Title area menu
  ...
  ![Select and run debugging command](https://github.com/microsoft/vscode-react-native/raw/HEAD/images/debug-commands-button.png)
...
1. Once the app is loaded and running, [open the developer menu](https://reactnative.dev/docs/debugging#accessing-the-in-app-developer-menu) and enable remote debugging by clicking on `Debug JS Remotely` button.
   ...
   ![React Native developer menu](https://github.com/microsoft/vscode-react-native/raw/HEAD/images/enable-remote-debug.png)
...
![image](https://github.com/microsoft/vscode-react-native/raw/HEAD/images/select-dev-menu.png)

![image](https://github.com/microsoft/vscode-react-native/raw/HEAD/images/dev-menu-setup-custom-host.png)

![image](https://github.com/microsoft/vscode-react-native/raw/HEAD/images/custom-host-and-port.png)
...
![image](https://github.com/microsoft/vscode-react-native/raw/HEAD/images/custom-keybindings.png)
