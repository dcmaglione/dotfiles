...
exports.IndentSpy = exports.deactivate = exports.activate = void 0;
...
class IndentSpy {
    ...
    _getActiveIndentRanges(document, selection, selectedIndent, tabSize) {
        ...
        let addRanges = (i, line) => {
            ...
            if (!innerDeactivated && (lineIndent > selectedIndent || (line.isEmptyOrWhitespace && selectedIndent === lineIndent &&
            ...
            if (this._outerConf.indentPos >= 0 && (lineIndent >= selectedIndent || (line.isEmptyOrWhitespace && selectedIndent === 1))) {
